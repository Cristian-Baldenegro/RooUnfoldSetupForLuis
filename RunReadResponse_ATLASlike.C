#include "./examples/RooUnfoldReadResponse_3D_ATLASlike.cxx"
void RunReadResponse_ATLASlike(int i )
{
  gSystem->Load("libRooUnfold.so");
  gROOT->ProcessLine(".L ./examples/RooUnfoldReadResponse_3D_ATLASlike.cxx");
...
//std::string mc_name = "", std::string jec_option = "", std::string jer_option ="", std::string pu_option = ""
  RooUnfoldReadResponse_3D_ATLASlike(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "nom", "nom", "nom", "ak4");
/*  RooUnfoldReadResponse_3D_ATLASlike(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "nom", "nom", "up", "ak4");
  RooUnfoldReadResponse_3D_ATLASlike(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "nom", "nom", "down", "ak4");
  RooUnfoldReadResponse_3D_ATLASlike(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "nom", "up", "nom", "ak4");
  RooUnfoldReadResponse_3D_ATLASlike(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "nom", "nom", "nom", "ak4");
  RooUnfoldReadResponse_3D_ATLASlike(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "nom", "down", "nom", "ak4");
  RooUnfoldReadResponse_3D_ATLASlike(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "up", "nom", "nom", "ak4");
  RooUnfoldReadResponse_3D_ATLASlike(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "down", "nom", "nom", "ak4");
  RooUnfoldReadResponse_3D_ATLASlike(ss_herwig7.str().c_str(),"","",i, year, "herwig7", "nom", "nom", "nom", "ak4");
  RooUnfoldReadResponse_3D_ATLASlike(ss_trackIneff.str().c_str(),"TrackIneff","trackIneff",i, year, "pythia8", "nom", "nom", "nom", "ak4");*/
