...
void RooUnfoldReadResponse_LundPlane(std::string cFiles2="",std::string tag = "", std::string date = "", int fileindex=0)
{
...
//  gSystem->Load("/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/interface/QCDEvent.h");
  ...
  RooUnfold::ErrorTreatment errorTreatment = RooUnfold::kCovariance;   
   ...
   //******************Fill the MCresponse*******************//
      ...
      TFile *input2=TFile::Open("/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/DATA_MG8_500MeV_0MeV.root");
...
//       histosTH2F["Lund_plane_gen_all"]->Fill(log(0.4/theta_gen.at(i)),log(kT_gen.at(i) ));
      ...
      {
       if (log(kT_reco.at(j)) < logkTmin || log(kT_reco.at(j)) > 4.0) continue;
...
//         cout << " we have a match with dR " << dR << " and kTratio " << kT_min << endl;
       ...
       for (unsigned l = 0; l < z_gen.size(); ++l) // loop over gen-level splitings, check if the previous match is true the other way around
       {
         ...
         if (log(0.4/theta_gen.at(l)) < 0. || log(0.4/theta_gen.at(l)) > 2.75) continue;
...
//     histosTH2F["Lund_plane_gen_matched"]->Fill(log(0.4/theta_gen.at(index_true)),log(kT_gen.at(index_true) ));
 ...
 TFile *fout = new TFile("/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/ResponseIsRead_test2.root","RECREATE");
  fout->cd();
...
#ifndef __CINT__
int main () { RooUnfoldReadResponse_LundPlane(); return 0; }  // Main program when run stand-alone
#endif
