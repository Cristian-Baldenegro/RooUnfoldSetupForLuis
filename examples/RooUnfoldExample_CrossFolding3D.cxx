...
void RooUnfoldExample_CrossFolding3D(std::string file_mc="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/ResponseIsRead3DHerwig7.root", std::string file_data="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/ResponseIsRead3DPythia8.root", std::string date = "3D",int flag=19)
{
  RooUnfold::ErrorTreatment errorTreatment = RooUnfold::kCovariance;   
  TFile* f_mc=new TFile(file_mc.c_str());
  TFile* f_data=new TFile(file_data.c_str());
  TH3D *h2raw=(TH3D*)f_data->Get("recoall");
  h2raw->SetName("raw");
  TH3D *h2recoall=(TH3D*)f_data->Get("recoall");
  h2recoall->SetName("recoall");
  TH3D *h2rawTrueBinning=(TH3D*)f_data->Get("rawTrueBinning");
  TH3D *h2smeared=(TH3D*)f_data->Get("smeared");
//  TH2D *h2recoall=(TH2D*)f_mc->Get("recoall");
  ...
  TH3D *h2true=(TH3D*)f_data->Get("true");
  TH3D *h2fulleff=(TH3D*)f_data->Get("truef");
...
//  TH2D *effdenom=(TH2D*)h2fulleff->Clone("effdenom");
  ...
  std::stringstream ss;
  ss << "UnfoldPythia8withHerwig7_" << date << flag<< ".root";
...
#ifndef __CINT__
int main () { RooUnfoldExample_CrossFolding3D(); return 0; }  // Main program when run stand-alone
#endif
