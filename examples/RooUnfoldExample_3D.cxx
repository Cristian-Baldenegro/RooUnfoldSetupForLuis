...
void RooUnfoldExample_3D(std::string file_mc="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/rootfiles/ReadResponse2016_herwig7_ak4.root", 
std::string file_data="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/rootfiles/ReadData2016.root", std::string date = "herwig7V32016_ak4",int flag=19)
{

//RooUnfold::ErrorTreatment errorTreatment = RooUnfold::kDagostini;
...
//      cout << unfold.Chi2(h2true) << endl;
//      unfold.IncludeSystematics(2);
//      
//      unfold_pT.IncludeSystematics(2);
       auto covariance = unfold.GetMeasuredCov();
//      auto covariance = unfold.Ereco();
//      if (jar == 10) cout << covariance.Determinant() << endl;
...
#ifndef __CINT__
int main () { RooUnfoldExample_3D(); return 0; }  // Main program when run stand-alone
#endif
