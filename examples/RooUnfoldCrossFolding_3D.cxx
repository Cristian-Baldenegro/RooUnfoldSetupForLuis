...
void RooUnfoldCrossFolding_3D(std::string file_mc="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/ReadResponseRun2V2_herwig7_ak4.root", 
std::string file_data="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/ReadResponseRun2V2_herwig7_ak4.root", std::string date = "H7dummytest_ak4",int flag=19)
{
...
//  TH3D *h2purity=(TH3D*)f_mc->Get("purity");
  ...
  TH1D *pTjet_true=(TH1D*)f_data->Get("pTjet_true");
...
//  h2fulleff->GetZaxis()->SetRange(2,2);
//  h2true->GetZaxis()->SetRange(2,2);
...
#ifndef __CINT__
int main () { RooUnfoldCrossFolding_3D(); return 0; }  // Main program when run stand-alone
#endif
