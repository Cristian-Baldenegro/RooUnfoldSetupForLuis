...
void RooUnfoldReadData_LundPlane(std::string cFiles2 = "",std::string tag = "", std::string date = "", int fileindex=0)
{
...
#ifndef __CINT__
int main () { RooUnfoldReadData_LundPlane(); return 0; }  // Main program when run stand-alone
#endif
