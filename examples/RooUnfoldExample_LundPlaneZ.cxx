...
void RooUnfoldExample_LundPlaneZ(std::string file_mc="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/ResponseIsRead_test3.root", std::string file_data="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/rawData.root", std::string date = "DATA",int flag=15)
{
...
//  TH2D *h2rawTrueBinning=(TH2D*)f_mc->Get("rawTrueBinning");
...
#ifndef __CINT__
int main () { RooUnfoldExample_LundPlaneZ(); return 0; }  // Main program when run stand-alone
#endif
