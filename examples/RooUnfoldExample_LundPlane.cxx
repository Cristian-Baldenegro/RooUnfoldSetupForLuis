...
void RooUnfoldExample_LundPlane(std::string file_mc="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/ResponseIsReadPythia8.root", std::string file_data="/grid_mnt/data__data.polcms/cms/cbaldene/gen_level_angularities_debug2/C10620p1/src/LundPlane_LLR/AnalysisFW/python/UnfoldingTest/RooUnfold/ReadData_merged4.root", std::string date = "DATA_with_HERWIG7",int flag=19)
{
...
//  h2recoall->Write(); 
  ...
  //  TMatrixT<double> covariance(306,306);
...
#ifndef __CINT__
int main () { RooUnfoldExample_LundPlane(); return 0; }  // Main program when run stand-alone
#endif
