...
void RunReadResponse(int i )
{
  ...
  std::stringstream mctype; int year = 2016;
...
/*  ss << "./inputmcfiles/mc" ; ss << yearPrefix.str().c_str(); ss << "_pythia8_";
  ...
  ss << "./inputmcfiles/mc" ; ss << yearPrefix.str().c_str(); ss << "_pythia8_ak8_";
  ss_trackIneff << "./inputmcfiles/mc"; ss_trackIneff << yearPrefix.str().c_str(); ss_trackIneff <<"_pythia8_trackIneff_ak8_"; 
  ss_herwig7 << "./inputmcfiles/mc"; ss_herwig7 << yearPrefix.str().c_str(); ss_herwig7 << "_herwig7_ak8_";
...
//std::string mc_name = "", std::string jec_option = "", std::string jer_option ="", std::string pu_option = ""
  RooUnfoldReadResponse_3D(ss.str().c_str(),"","",i, year, mctype.str().c_str(), "nom", "nom", "nom", "ak8");
