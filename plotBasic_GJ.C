...
void plotBasic_GJ(int flagdummy,std:: string file, std::string fileother, int bintruexj1, int bintruexj2, int bintruerg1, int bintruerg2, int iter_ref)
{
...
//    ssn << "correff"<< bintruexj1<<"-"<<bintruexj2;           
    ...
    data=(TH2D*)f->Get("raw"); 
		...
		effxj->Divide(effdenomxj);
		 ...
		 fold2d=(TH2D*)f->Get(Form("Bayesian_Foldediter%d.root",j+1));
                 unfold[j]=(TH1D*)unfold2d[j]->ProjectionX(Form("unfold%d",j),1,-1,"");
	  ...
	  for(Int_t k=2; k<13; k++)
  	  ...
  	  pad->cd();
  	   ...
  	   histotot->GetYaxis()->SetTitle("Summed errors");
           ...
           lego->Draw();
           lego->SetFillColor(0);  
           DrawLatex(0.2, 0.85, 1,Form("Bayes unfolded,ln(k_{T}/GeV)^{true} bin [%i,%i]",bintruexj1,bintruexj2),0.03);
           DrawLatex(0.2, 0.8, 1,"13 TeV (2016), p_{T}^{jet}>500 GeV, |y^{jet}| < 2",0.03); 
           DrawLatex(0.2, 0.75, 1,Form("anti-k_{T}, R=0.4"),0.03); 
           canv1->SaveAs("IterChoice_rg_GJ.png");
  ...
  unfold[0]->GetXaxis()->SetRangeUser(-0.05,0.35);
   unfold[0]->GetYaxis()->SetRangeUser(0.,2);
  	   ...
  	   unfold[0]->GetXaxis()->SetTitle("ln(R/#Delta R)");
    ...
    canv2->SaveAs("UnfvsIterRgGJ.png");
  ...
  fold[0]->GetYaxis()->SetTitleSize(0.065);
  	   ...
  	   fold[0]->GetXaxis()->SetTitle("ln(R/#Delta R)");
  	  ...
  	  fold[0]->Draw("");
  	   ...
  	   lego->Draw();
     	   lego->SetFillColor(0);
	   DrawLatex(0.4, 0.4, 1,Form("Refolding test ln(k_{T}/GeV)^{det} bin [%i,%i]",1,-1),0.03);
           DrawLatex(0.4, 0.35, 1,"13 TeV (2016), p_{T}^{jet}>500 GeV, |y^{jet}| < 2",0.03);
           DrawLatex(0.4, 0.3, 1,"anti-k_{T}, R=0.4",0.03);


  	   canv3->SaveAs("RefoldvsIterRgGJ.png");
  ...
  ptunfold[0]->GetXaxis()->SetRangeUser(40,120);ptunfold[0]->GetYaxis()->SetRangeUser(0,2);
  	   ptunfold[0]->GetXaxis()->SetTitle("ln(k_{T}/GeV)");
	   ...
	   if(flagdummy>=1)ptunfold[0]->Divide(pthtrue1);
  	  ...
  	  for(Int_t k=1;k<15;k++)
  	    ...
  	    ptunfold[k]->Draw("same");
            ...
            DrawLatex(0.2, 0.85, 1,Form("Bayes unfolded, ln(R/#Delta R)^{true} bin  [%i,%i]",bintruerg1,bintruerg2),0.03);
            DrawLatex(0.2, 0.8, 1,"13 TeV (2016), p_{T}^{jet}>500 GeV, |y^{jet}| < 2",0.03);
            DrawLatex(0.2, 0.75, 1,"anti-k_{T}, R=0.4",0.03);
	
  	  canv4->SaveAs("UnfoldvsIterxj.png");
  ...
  ptfold[0]->GetYaxis()->SetTitleSize(0.065);
  	   ...
  	   ptfold[0]->GetXaxis()->SetTitle("ln(k_{T}/GeV)");
  	  ...
  	  ptfold[0]->Draw("");
  	   ...
  	   lego->Draw();
     	   lego->SetFillColor(0);
             ...
             DrawLatex(0.2, 0.85, 1,Form("Refolding test, ln(R/#Delta R)^{reco} bin  [%i,%i]",1,-1),0.03);
             DrawLatex(0.2, 0.8, 1,"13 TeV (2016), p_{T}^{jet}>500 GeV",0.03);
             DrawLatex(0.2, 0.75, 1,"anti-k_{T}, R=0.4",0.03);
          
  	  canv5->SaveAs("RefoldvsIterXJ.png");
  ...
  raw->GetYaxis()->SetTitleSize(0.065);
  	  ...
  	  raw->GetYaxis()->SetTitle("ln(k_{T}/GeV)");
  	  raw->GetXaxis()->SetTitle("ln(R/#Delta R)");
  	  raw->Draw("text");

          
  
  	  canv6->SaveAs("RawStats_GJ.png");
  	  ...
  	  eff->GetXaxis()->SetTitle("ln(R/#Delta R)");
   	  eff->Draw("");
          DrawLatex(0.2, 0.8, 1,Form("Kinematic efficiency for the true bin ln(k_{T}/GeV)  [%i,%i]",bintruexj1,bintruexj2),0.025);
 	  canv7->SaveAs("Kineff_rg_GJ.png");
 ...
 canv8= new TCanvas(Form("canvas8"),Form("canvas8") ,1100,1100);
  ...
  effxj->GetYaxis()->SetTitleSize(0.065);
  	   ...
  	   effxj->GetYaxis()->SetTitle("efficiency");
  	  effxj->GetXaxis()->SetTitle("ln(k_{T}/GeV)");
  	  effxj->Draw("");
    DrawLatex(0.2, 0.8, 1,Form("Kinematic efficiency for the true bin ln(R/#Delta R) [%i,%i]",bintruerg1,bintruerg2),0.025);
	  canv8->SaveAs("eff_lnKt_LundPlane.png");
...
canv9= new TCanvas(Form("canvas9"),Form("canvas9") ,1100,1100);
 ...
 denom->GetYaxis()->SetRangeUser(0.,15);
  ...
  if(flagdummy>=1)         denom->GetYaxis()->SetTitle("True MC");
  	  denom->GetXaxis()->SetTitle("ln(R/#Delta R)");
  	  denom->Draw("");
    ...
    lego->SetTextSize(0.025);
    lego->SetTextFont(42);
    lego->AddEntry(denom,"0<ln(k_{T}/GeV)<2", "L");
    lego->AddEntry(denom2,"3 < ln(k_{T}/GeV) < 4", "L");
    lego->Draw();
    lego->SetFillColor(0);
    canv9->SaveAs("Rg_unfolded.png");      	  
}
